    ...
    <footer className={styles.Footer}>
      <div className={styles.InnerFooter}>
        <div className={styles.Col}>
          <a href="#">{t('visitorsSpecial', lang)}</a>
          <a href="#">{t('tickets', lang)}</a>
          <a href="#">{t('corruption', lang)}</a>
          <div className={styles.Social}>
            <h3>{t('social', lang)}</h3>
            <a href="mailto:museum@museum.ru" aria-label={t('email', lang)} className={styles.IconMail} />
            <a href="#" aria-label={t('tg', lang)} className={styles.IconTg} />
            <a href="#" aria-label={t('fb', lang)} className={styles.IconFb} />
          </div>
        </div>
        <div className={styles.Col}>
